...
powershell.exe -NoProfile -Command ^
    ...
    "$shortcut.WorkingDirectory = '\\wsl.localhost\Ubuntu\home\unknow\projects\firmware\firmware\wqn-zectrix-note4\scripts'; " ^
    "$shortcut.Description = 'WQN Note4 Firmware Deployment for COM5 (with Auto 16MB Backup)'; " ^
    "$shortcut.Save(); " ^
